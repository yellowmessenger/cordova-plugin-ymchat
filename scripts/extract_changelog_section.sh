#!/usr/bin/env bash
# Extracts the CHANGELOG.md section for a given release version (e.g. "3.4.2",
...
#
# Usage: extract_changelog_section.sh <version e.g. 3.4.2> [changelog-file]

set -euo pipefail

VERSION="${1:?usage: extract_changelog_section.sh <version e.g. 3.4.2> [changelog-file]}"
